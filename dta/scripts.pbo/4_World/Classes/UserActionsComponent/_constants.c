...
const int AT_DIG_OUT_STASH = 174;
...
//const int AT_ATTACH_METAL_WIRE = 532; UNUSED
...
const int AT_HEADTORCH_ON = 586;
const int AT_HEADTORCH_OFF = 587;
const int AT_HELMETFLASHLIGHT_ON = 588;
const int AT_HELMETFLASHLIGHT_OFF = 589;
