...
class UserActionsConflictGroups
{
	class ActionGroups
	{
		...
		buldozer[]=
		{
			...
			"BuldBrushOuterDown",
			"BuldBrushStrengthUp",
			"BuldBrushStrengthDown",
			"BuldToggleNearestObjectArrow",
			"BuldCycleBrushMod",
			"BuldSelectionType",
			"BuldCreateLastSelectedObject",
			"BuldDuplicateSelection",
			"BuldDeleteSelection",
			"BuldUndo",
			"BuldRedo",
			"BuldObjectRotateLeft",
			"BuldObjectRotateRight",
			"BuldObjectRotateForward",
			"BuldObjectRotateBack",
			"BuldViewerMoveLeft",
			"BuldViewerMoveRight",
			"BuldViewerMoveForward",
			"BuldViewerMoveBack",
			"BuldViewerMoveUp",
			"BuldViewerMoveDown",
			"BuldMoveLeft",
			...
			"BuldTurbo",
			"BuldSlow",
			"BuldPreviousAnimation",
			"BuldNextAnimation",
			"BuldRecedeAnimation",
			"BuldAdvanceAnimation",
			"BuldZoomIn",
			"BuldZoomOut",
			"BuldTextureInfo"
		};
		...
		class Weather
		{
			class LightingNew
			{
				class C_Night
				{
					...
					diffuse[]=
					{
						{0.035999998,0.056000002,0.086999997},
						0.80000001
					};
					diffuseCloud[]=
					{
				...
				class C_Astro2
				{
					...
					ambient[]=
					{
						{0.032000002,0.063199997,0.096000001},
						0.1
					};
					ambientCloud[]=
					{
				...
				class C_Nautical1
				{
					...
					skyAroundSun[]=
					{
						{0.60390002,0.54110003,0.45089999},
						0.40000001
					};
					desiredLuminanceCoef=0.15000001;
					desiredLuminanceCoefCloud=0.15000001;
				...
				class C_Day12
				{
					...
					desiredLuminanceCoef=0.56999999;
					desiredLuminanceCoefCloud=0.56999999;
					luminanceRectCoef=0;
					luminanceRectCoefCloud=0;
					rayleigh[]={0,0,0};
					mie[]={0,0,0};
				...
				class C_Day16
				{
					...
					bidirectCloud[]={0.059999999,0.059999999,0.059999999};
					sky[]=
					{
						{0.5,0.63999999,1},
						11
				...
				class O_Astro1
				{
					...
					ambient[]={0.0040000002,0.0078999996,0.012};
					ambientCloud[]={0.0040000002,0.0078999996,0.012};
					groundReflection[]={0,0,0};
					groundReflectionCloud[]={0,0,0};
					bidirect[]={0,0,0};
					bidirectCloud[]={0,0,0};
				...
				class O_Day0
				{
					...
					bidirectCloud[]={0.064999998,0.064999998,0.064999998};
					sky[]=
					{
						{0.1,0.14,0.22},
						3.7149999
...
class RscMapControl
{
	...
	colorMountPoint[]={0.64999998,0.44999999,0.27000001,1};
...
class RscDisplayInventory
{
	...
	dragColorMove[]={0.59299999,0.88599998,0.59299999,1};
	dragColorCraft[]={0.92000002,0.67000002,0.090000004,1};
	dragColorSwap[]={0.59299999,0.88599998,0.88599998,1};
	dragColorUnlock[]={1,1,1,1};
	tooltipHeight=0.2;
	...
	class Objects
	{
		class Container: RscObject
		{
			...
			colorLockedBackground[]={0.30000001,0.30000001,0.30000001,1};
		...
		class Shortcut1: RscObject
		{
			...
			colorBorder[]={0.5,0.5,0.5,1};
			colorText[]={1,1,1,1};
			colorBackgroundInactive[]={1,0,0,0.5};
			colorBorderInactive[]={0.5,0,0,0.5};
