...
//Produced from mikero's Dos Tools Dll version 7.02
//https://armaservices.maverick-applications.com/Products/MikerosDosTools/default
//'now' is Wed Jan 09 01:39:40 2019 : 'file' last modified on Thu Dec 13 04:50:16 2018
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class V3S_Chassis: CarScript
	{
		...
		InteractActions[] = {1047,1035};
		attachments[] = {"TruckBattery","LightBulb","V3SDriverDoors","V3SCoDriverDoors","V3SHood","V3SWheel_1_1","V3SWheel_1_2","V3SWheel_1_3","V3SWheel_2_1","V3SWheel_2_2","V3SWheel_2_3","V3SWheel_Spare_1","V3SWheel_Spare_2"};
			...
			class DamageZones
			{
				...
				class Front
				{
					class Health
					{
						hitpoints = 2500;
						transferToGlobalCoef = 0;
						healthLevels[] = {{1.0,{"dz\vehicles\wheeled\offroadhatchback\data\v3s_cab.rvmat"}},{0.7,{}},{0.5,{"dz\vehicles\wheeled\offroadhatchback\data\v3s_cab_damage.rvmat"}},{0.3,{}},{0.0,{"dz\vehicles\wheeled\offroadhatchback\data\v3s_cab_destruct.rvmat"}}};
					};
				...
				class Roof
				{
					class Health
					{
						hitpoints = 500;
						transferToGlobalCoef = 0;
						healthLevels[] = {{1.0,{"dz\vehicles\wheeled\offroadhatchback\data\v3s_cabin_a.rvmat"}},{0.7,{}},{0.5,{"dz\vehicles\wheeled\offroadhatchback\data\v3s_cabin_a_damage.rvmat"}},{0.3,{}},{0.0,{"dz\vehicles\wheeled\offroadhatchback\data\v3s_cabin_a_destruct.rvmat"}}};
					};
	...
	class HatchbackWheel: CarWheel
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 200;
					healthLevels[] = {{1.0,{"DZ\vehicles\wheeled\OffroadHatchback\data\niva_wheel.rvmat"}},{0.7,{}},{0.5,{"DZ\vehicles\wheeled\OffroadHatchback\data\niva_wheel_damage.rvmat"}},{0.3,{}},{0.0,{"DZ\vehicles\wheeled\OffroadHatchback\data\niva_wheel_destruct.rvmat"}}};
				};
			};
		};
	};
	...
	class OffroadHatchback: CarScript
	{
		...
		attachments[] = {"CarBattery","Reflector_1_1","Reflector_2_1","CarRadiator","SparkPlug","NivaHood","NivaTrunk","NivaDriverDoors","NivaCoDriverDoors","NivaWheel_1_1","NivaWheel_1_2","NivaWheel_2_1","NivaWheel_2_2","NivaWheel_Spare_1"};
			...
			class DamageZones
			{
				...
				class Front
				{
					class Health
					{
						hitpoints = 1500;
						transferToGlobalCoef = 0;
						healthLevels[] = {{1.0,{"dz\vehicles\wheeled\offroadhatchback\data\niva.rvmat"}},{0.7,{}},{0.5,{"dz\vehicles\wheeled\offroadhatchback\data\niva_damage.rvmat"}},{0.3,{}},{0.0,{"dz\vehicles\wheeled\offroadhatchback\data\niva_destruct.rvmat"}}};
					};
				...
				class Engine
				{
					class Health
					{
						hitpoints = 1000;
						transferToGlobalCoef = 1;
						healthLevels[] = {{1.0,{"dz\vehicles\wheeled\offroadhatchback\data\engine_niva.rvmat"}},{0.7,{}},{0.5,{"dz\vehicles\wheeled\offroadhatchback\data\engine_niva_damage.rvmat"}},{0.3,{}},{0.0,{"dz\vehicles\wheeled\offroadhatchback\data\engine_niva_destruct.rvmat"}}};
					};
					memoryPoints[] = {"dmgZone_engine"};
					componentNames[] = {"dmgZone_engine"};
					fatalInjuryCoef = 0.001;
